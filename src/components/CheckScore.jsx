...
function CheckScore() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] md:min-h-0 px-2">
      <div className="card w-full max-w-md shadow-xl border border-slate-100">
        <div className="text-center mb-6 border-b border-slate-100 pb-4">
          <p className="text-slate-500 font-bold mb-1 uppercase tracking-widest text-[10px] md:text-xs">แบบประเมินความสะอาด</p>
          <h2 className="text-3xl md:text-4xl font-black text-slate-800">ห้อง {room}</h2>
        </div>
        
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div>
            <div className="flex justify-between items-center mb-3">
              <label className="text-base md:text-lg font-bold text-slate-700">ระดับความสะอาด</label>
              <span className="text-4xl md:text-5xl font-black text-blue-600 w-20 text-right italic">
                {score}
              </span>
            </div>
            ...
            <div className="pt-3 pb-6 px-1">
              ...
              />
              <div className="flex justify-between text-[10px] font-black text-slate-400 mt-3 px-0.5 uppercase tracking-widest">
          ...
          <button 
            type="submit" 
            className="btn btn-primary w-full py-4 md:py-5 text-lg md:text-xl font-bold shadow-lg shadow-blue-500/30 active:scale-[0.97] transition-transform" 
            disabled={loading}
          >
            {loading ? (
